...
Promise.all([
    ...
    faceapi.nets.faceRecognitionNet.loadFromUri(`${localHost}/models2`),
    faceapi.nets.faceLandmark68Net.loadFromUri(`${localHost}/models2`),
    faceapi.nets.ssdMobilenetv1.loadFromUri(`${localHost}/models2`)
]).then(start);
